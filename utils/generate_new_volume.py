...
def generate_new_volume_anisotropic(model_path='model/sliceGAN', lz_0=6, lz_1=6, lz_2=6):
    ## Data Processing
    # Define image type (colour, grayscale, three-phase or two-phase.
    # n-phase materials must be segmented)
    image_type = 'nphase'
    ...
    vol = util.generate_volume_anisotropic(model_path, image_type, netG(), nz=z_channels, lz_0=lz_0, lz_1=lz_1, lz_2=lz_2)
    return vol
